...
# 9 "adc ghep trong.c" 2

# 1 "./lcd_hd44780_pic16.h" 1
# 13 "./lcd_hd44780_pic16.h"
...
(LCDByte(Digit[2]+0x30,1));
(LCDByte('.',1));
(LCDByte(Digit[1]+0x30,1));
(LCDByte(Digit[0]+0x30,1));
