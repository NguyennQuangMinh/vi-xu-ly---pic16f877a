# 1 "giao tiep nut nhan voi led.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "giao tiep nut nhan voi led.c" 2
# 15 "giao tiep nut nhan voi led.c"
...
# 33 "giao tiep nut nhan voi led.c" 2
...
# 34 "giao tiep nut nhan voi led.c" 2
...
void ledsangduoi( unsigned int n)
{
    while(n--)
    {
        for(i=0;i<8;i++)
...
void ledsangdan (unsigned int n)
{
    unsigned b = 0x01;
    while (n--)
    {
