# 1 "giao tiep nut nhan led 7 seg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "giao tiep nut nhan led 7 seg.c" 2
# 15 "giao tiep nut nhan led 7 seg.c"
...
# 33 "giao tiep nut nhan led 7 seg.c" 2
...
# 34 "giao tiep nut nhan led 7 seg.c" 2
...
# 35 "giao tiep nut nhan led 7 seg.c" 2



unsigned char led7seg[10]={ 0xC0 , 0xF9 , 0xA4 , 0xB0 , 0x99 , 0x92 , 0x82 , 0xF8 , 0x80 , 0x90 };
unsigned char num_disp;
# 80 "giao tiep nut nhan led 7 seg.c"
void main(void) {
    ANSEL = ANSELH = 0x00;
    TRISC = 0x00;
    TRISD= 0x00;
