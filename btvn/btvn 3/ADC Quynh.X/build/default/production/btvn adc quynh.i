...
void HienThi_7seg(void){
    ...
    switch (digit){
        case 0:
            PORTCbits.RC3=0;PORTCbits.RC2=1;PORTCbits.RC1=1;
            PORTB=ma[tram];
        break;
        case 1:
            PORTCbits.RC3=1;PORTCbits.RC2=0;PORTCbits.RC1=1;
            PORTB=ma[chuc];
        break;
        case 2:
            PORTCbits.RC3=1;PORTCbits.RC2=1;PORTCbits.RC1=0;
            PORTB=ma[donvi];
    }
}
