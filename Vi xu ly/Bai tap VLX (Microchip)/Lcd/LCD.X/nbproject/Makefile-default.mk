...
SOURCEFILES_QUOTED_IF_SPACED=main.c lcd_hd44780_pic16.c ADC0808.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/lcd_hd44780_pic16.p1 ${OBJECTDIR}/ADC0808.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/lcd_hd44780_pic16.p1.d ${OBJECTDIR}/ADC0808.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/lcd_hd44780_pic16.p1 ${OBJECTDIR}/ADC0808.p1

# Source Files
SOURCEFILES=main.c lcd_hd44780_pic16.c ADC0808.c
...
${OBJECTDIR}/ADC0808.p1: ADC0808.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ADC0808.p1.d 
	@${RM} ${OBJECTDIR}/ADC0808.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=pickit3    -fshort-double -fshort-float -O1 -fasmfile -maddrqual=ignore -D_XTAL_FREQ=16000000 -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mdefault-config-bits $(COMPARISON_BUILD)  -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/ADC0808.p1 ADC0808.c 
	@-${MV} ${OBJECTDIR}/ADC0808.d ${OBJECTDIR}/ADC0808.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/ADC0808.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
