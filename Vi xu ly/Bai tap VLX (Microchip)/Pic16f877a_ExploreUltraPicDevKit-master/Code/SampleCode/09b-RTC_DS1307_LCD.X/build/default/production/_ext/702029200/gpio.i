...
# 2 "<built-in>" 2
# 1 "../00-libfiles/gpio.c" 2
# 36 "../00-libfiles/gpio.c"
...
# 39 "../00-libfiles/gpio.c" 2

#pragma warning push
#pragma warning disable 752
#pragma warning disable 1496
# 60 "../00-libfiles/gpio.c"
void GPIO_PinDirection(gpioPins_et enm_pinNumber, uint8_t var_pinDirn_u8)
{
    ...
    var_portNumber_u8 = (enm_pinNumber>>3);
    enm_pinNumber = enm_pinNumber & 0x07;
    ...
    case 0:
        ((var_pinDirn_u8)? ((TRISA) |= (1<<(enm_pinNumber))): ((TRISA) &= ~(1<<(enm_pinNumber))));
        break;



    case 1:
        ((var_pinDirn_u8)? ((TRISB) |= (1<<(enm_pinNumber))): ((TRISB) &= ~(1<<(enm_pinNumber))));
        break;



    case 2:
        ((var_pinDirn_u8)? ((TRISC) |= (1<<(enm_pinNumber))): ((TRISC) &= ~(1<<(enm_pinNumber))));
        break;



    case 3:
        ((var_pinDirn_u8)? ((TRISD) |= (1<<(enm_pinNumber))): ((TRISD) &= ~(1<<(enm_pinNumber))));
        break;


    case 4:
        ((var_pinDirn_u8)? ((TRISE) |= (1<<(enm_pinNumber))): ((TRISE) &= ~(1<<(enm_pinNumber))));
        break;

    }
}
# 127 "../00-libfiles/gpio.c"
void GPIO_PinWrite(gpioPins_et enm_pinNumber, uint8_t var_pinValue_u8)
{
    ...
    case 0:
        ((var_pinValue_u8)? ((PORTA) |= (1<<(enm_pinNumber))): ((PORTA) &= ~(1<<(enm_pinNumber))));
        break;



    case 1:
        ((var_pinValue_u8)? ((PORTB) |= (1<<(enm_pinNumber))): ((PORTB) &= ~(1<<(enm_pinNumber))));
        break;



    case 2:
        ((var_pinValue_u8)? ((PORTC) |= (1<<(enm_pinNumber))): ((PORTC) &= ~(1<<(enm_pinNumber))));
        break;



    case 3:
        ((var_pinValue_u8)? ((PORTD) |= (1<<(enm_pinNumber))): ((PORTD) &= ~(1<<(enm_pinNumber))));
        break;



    case 4:
        ((var_pinValue_u8)? ((PORTE) |= (1<<(enm_pinNumber))): ((PORTE) &= ~(1<<(enm_pinNumber))));
        break;

    }
}
# 192 "../00-libfiles/gpio.c"
uint8_t GPIO_PinRead(gpioPins_et enm_pinNumber)
{
    uint8_t var_portNumber_u8;
    ...
    case 0:
        returnStatus = (((PORTA)&((1<<(enm_pinNumber))))!=0u);
        break;


    case 1:
        returnStatus = (((PORTB)&((1<<(enm_pinNumber))))!=0u);
        break;


    case 2:
        returnStatus = (((PORTC)&((1<<(enm_pinNumber))))!=0u);
        break;



    case 3:
        returnStatus = (((PORTD)&((1<<(enm_pinNumber))))!=0u);
        break;



    case 4:
        returnStatus = (((PORTE)&((1<<(enm_pinNumber))))!=0u);
        break;
    }
    return returnStatus;
}
