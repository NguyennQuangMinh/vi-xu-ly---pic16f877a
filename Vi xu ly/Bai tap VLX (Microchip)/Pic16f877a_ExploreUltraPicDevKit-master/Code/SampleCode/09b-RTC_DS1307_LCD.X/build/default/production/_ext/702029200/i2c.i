...
# 2 "<built-in>" 2
# 1 "../00-libfiles/i2c.c" 2
# 43 "../00-libfiles/i2c.c"
...
# 44 "../00-libfiles/i2c.c" 2
# 1 "../00-libfiles/i2c.h" 1
# 46 "../00-libfiles/i2c.h"
...
# 47 "../00-libfiles/i2c.h" 2
# 68 "../00-libfiles/i2c.h"
void I2C_Init();
void I2C_Start();
void I2C_Stop(void);
void I2C_Write(uint8_t );
uint8_t I2C_Read(uint8_t);
# 45 "../00-libfiles/i2c.c" 2
...
# 68 "../00-libfiles/i2c.c"
void I2C_Restart()
{
 RSEN = 1;
 while(RSEN);
}
# 87 "../00-libfiles/i2c.c"
void I2C_Init()
{
 TRISC3 = 0x01u;
 TRISC4 = 0x01u;
...
# 147 "../00-libfiles/i2c.c"
void I2C_Stop(void)
{
 PEN = 1;
 while(PEN == 1);
}
# 179 "../00-libfiles/i2c.c"
...
# 258 "../00-libfiles/i2c.c"
static void i2c_WaitForIdle()
{
    while ( (SEN == 1) || (RSEN == 1) || (PEN == 1) || (RCEN == 1) || (R_W == 1) );

}
# 279 "../00-libfiles/i2c.c"
static void i2c_Ack()
{
 ACKDT = 0;
 ACKEN = 1;
