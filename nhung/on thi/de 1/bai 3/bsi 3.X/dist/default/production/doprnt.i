...
# 661 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
  ...
  case 0:
   goto alldone;
# 708 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
  case 'g':
   flag |= 0x200;
   break;
...
# 848 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
  ...
  if(flag & (0x700)) {
   ...
   if(
    ...
    if( fval!=0) {
     fval /= scale(eexp-c);
# 919 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
...
# 985 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
    {
# 999 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
     if(flag & 0x03)
      ((*sp++ = ('-')));
    ...
    if(eexp < 0) {
     ...
     ((*sp++ = ('+')));
# 1065 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
...
# 1113 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c90\\common\\doprnt.c"
    if(flag & 0x200) {
     if(eexp < 0)
      prec -= (eexp+1);
